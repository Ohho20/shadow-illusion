angular.module('game.screens.death', [])

.factory('DeathScreen', function (ScrollingDeathText) {
    ...
    return me.ScreenObject.extend({
      ...
      onResetEvent: function() {  
        ...
        me.game.world.addChild(
          new me.SpriteObject(
            0,0,me.loader.getImage('cave')
          ),
          1
        );

        // renderable component with scrolling text
        me.game.world.addChild( new ScrollingDeathText(), 2);
  ...
  .factory('ScrollingDeathText', function () {
    return me.Renderable.extend({
      init : function() {
        ...
        this.scroller = "NICE TRY, GIVE IT ANOTHER SHOT.         I BET YOU CAN DO IT THIS TIME!       ";
      ...
      draw : function (context) {
        this.font.draw(context, "YOU DIED!!", 128, 64);
